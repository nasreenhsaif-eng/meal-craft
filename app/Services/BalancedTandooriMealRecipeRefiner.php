    ...
    private function recipeDefinitions(): array
    {
        ...
        return [
            'Tandoori Chicken Salad' => [
                ...
                'instructions' => [
                    'Slice prepared Tandoori Chicken (Base) — marinated with Tandoori Spice Mix (Base).',
                    'Toss romaine, cucumber, celery, tomatoes, onion, herbs, and pomegranate.',
                    'Top with chicken, cashews, and mint coconut chutney dressing.',
                ],
                'diet_tags' => $spicyTags,
            ],
            'Tandoori Coconut Mint Salad' => [
                ...
                'instructions' => [
                    ...
                    'Top with chicken, cashews, and pomegranate. Finish with chutney dressing and a pinch of black seeds.',
                ],
                'diet_tags' => $spicyTags,
            ],
            'Crispy Chicken Tikka bowl w Quinoa & Mint Sauce' => [
                ...
                'instructions' => [
                    ...
                    'Grill or crisp Tandoori Chicken (Base) until golden; slice.',
                    'Shred cabbage; julienne carrots and cucumber.',
                    'Layer quinoa, vegetables, and chicken. Drizzle cashew mint sauce and lime.',
                ],
                'diet_tags' => $spicyTags,
            ],
        ];
