...
3. Chill 30 minutes until firm. Serve cold.',
  ...
  array (
    ...
    'highlight' => 'Premium baked salmon with fermented chimichurri over fluffy steamed basmati rice and broccoli.',
    'short_description' => 'Premium baked salmon with fermented chimichurri over fluffy steamed basmati rice and broccoli.',
    'instructions' => 'Prepare Steamed Basmati Rice (Base) and keep warm.
...
Serve skewers with zereshk turmeric rice, roasted vegetables on the side, and fresh parsley.',
  ...
  array (
    ...
    'short_description' => 'Grilled halloumi folded through softly scrambled eggs with wilted spinach.',
    'instructions' => '1. Heat half the olive oil in a non-stick skillet over medium heat. Wilt spinach for 1 minute, then set aside.
2. Grill halloumi in the remaining oil until golden on both sides.
3. Beat eggs, add to the skillet with a little more oil if the pan looks dry, and scramble gently until just set.
4. Fold halloumi and spinach through the eggs. Season with black pepper and serve warm.',
    'diet_tags' => 
    array (
      0 => 'Dairy-free',
      1 => 'Gluten-free',
