/**
 * Compact horizontal ft/in vs cm toggle for onboarding measurement steps.
 *
 * @param {{
 *   value: 'cm' | 'ft_in';
 *   onChange: (value: 'cm' | 'ft_in') => void;
 *   className?: string;
 * }} props
 */
export function MeasurementUnitToggle({ value, onChange, className = '' }) {
    const options = [
...
export default MeasurementUnitToggle;
