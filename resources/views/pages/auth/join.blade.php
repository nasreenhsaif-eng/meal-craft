<x-layouts::auth :title="__('Join Meal Craft')">
    <div class="flex flex-col items-center gap-10 font-['Montserrat']">
        ...
        <div class="flex w-full max-w-[492px] flex-col items-center gap-[19px] text-center">
            <h1 class="text-2xl font-semibold leading-tight text-black">{{ __('Start your meal plan') }}</h1>
            <p class="text-base font-normal leading-normal text-black">{{ __('Create your customer account to personalize meals and track your nutrition goals.') }}</p>
        </div>
